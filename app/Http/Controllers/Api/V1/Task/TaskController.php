...
use App\Services\TaskIndexQuery;
...
class TaskController extends Controller
{
    public function index(Request $request, Workspace $workspace, Project $project)
    {
        ...
        $taskIndexQuery = app(TaskIndexQuery::class);
        $query = $taskIndexQuery->build($request, $project);
        $tasks = $query->paginate($taskIndexQuery->perPage($request));
